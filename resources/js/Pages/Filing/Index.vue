    ...
    <app-layout>
        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 py-1">
            <InputSearch
                ...
                size="small"
            />
            <Button @click="uploadFile" class="ml-2" size="small"
                >Upload File</Button
            >
            <Button @click="templates" class="ml-2" size="small"
                >Templates</Button
            >
            ...
            <label v-else class="ant-btn ant-btn-sm ml-2" for="selected">
                Select All</label
            >
            <Button @click="Approve()" class="ml-2" size="small"
                >Approve</Button
            >
...
export default {
    ...
    methods: {
        onSearch() {
            if (
                this.parent.name == "Planing" ||
                this.parent.name == "Completion"
            ) {
                this.$inertia.get(
