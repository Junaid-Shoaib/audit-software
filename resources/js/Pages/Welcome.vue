...
<template>
    ...
    >
        ...
        <div class="flex w-screen h-screen z-10 bg-gray-900 overflow-hidden">
            <img
                src="../../../public/images/front3.jpg"
                class="w-full h-full object-cover px-2 animate-groww bg-[length:100%] overflow-hidden"
                alt=""
            />
            <div
                v-if="canLogin"
            ...
            >
                <Link
                    ...
                    class="text-md font-bold border border-blue-400 text-white bg-blue-600 rounded-2xl px-4 py-1 hover:bg-blue-700"
                >
                    Dashboard
                </Link>
                ...
                <template v-else>
                    <Link
                        :href="route('login')"
                        class="text-md border border-gray-400 text-center text-white bg-gray-600 rounded-2xl px-4 py-1 hover:bg-gray-700"
                    >
                        Login
                    </Link>
            ...
            <div
                class="absolute z-20 invisible md:visible w-50% my-2 text-left"
            >
                <p
                    class="text-white text-3xl font-sans mx-10 mt-10 drop-shadow-[4px_4px_16px_rgba(0,0,255)]"
                >
                    MZ-AMS
                </p>
            ...
            <div
                class="absolute z-20 invisible md:visible bottom-16 right-10 drop-shadow-[4px_4px_16px_rgba(0,0,255)]"
            >
            ...
            <div
                class="flex flex-row bottom-px items-center w-full justify-center fixed px-6 py-2"
            >
                <div class="">
                    <p
                        class="text-sm font-bold bg-blend-screen text-white ml-5 drop-shadow-[4px_4px_16px_rgba(0,0,255)]"
                    >
